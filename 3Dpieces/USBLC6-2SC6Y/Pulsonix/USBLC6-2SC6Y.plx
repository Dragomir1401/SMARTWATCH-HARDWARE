...
(library Library_1
	...
	(symbolDef "USBLC6-2SC6Y" (originalName "USBLC6-2SC6Y")
	...
	(compDef "USBLC6-2SC6Y" (originalName "USBLC6-2SC6Y") (compHeader (numPins 6) (numParts 1) (refDesPrefix D)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "USBLC6-2SC6Y"))
		...
		(attr "Manufacturer_Part_Number" "USBLC6-2SC6Y")
		(attr "Mouser Part Number" "511-USBLC6-2SC6Y")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/STMicroelectronics/USBLC6-2SC6Y?qs=gNDSiZmRJS%2FOgDexvXkdow%3D%3D")
		(attr "Arrow Part Number" "USBLC6-2SC6Y")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/usblc6-2sc6y/stmicroelectronics?region=nac")
		(attr "Description" "Low Cap. ESD Protection Auto SOT-23-6 STMicroelectronics USBLC6-2SC6Y, Dual Uni-Directional TVS Diode Array, 6-Pin SOT-23")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/1/USBLC6-2SC6Y.pdf")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "USBLC6-2SC6Y.stp")
