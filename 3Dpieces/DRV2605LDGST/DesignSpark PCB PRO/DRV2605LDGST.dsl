...
(library Library_1
	...
	(symbolDef "DRV2605LDGST" (originalName "DRV2605LDGST")
	...
	(compDef "DRV2605LDGST" (originalName "DRV2605LDGST") (compHeader (numPins 10) (numParts 1) (refDesPrefix IC)
		)
		(compPin "1" (pinName "REG") (partNum 1) (symPinNum 1) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(compPin "4" (pinName "IN/TRIG") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "EN") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "10" (pinName "VDD") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "9" (pinName "OUT-") (partNum 1) (symPinNum 7) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "8" (pinName "GND") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "7" (pinName "OUT+") (partNum 1) (symPinNum 9) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "6" (pinName "VDD/NC") (partNum 1) (symPinNum 10) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "DRV2605LDGST"))
		...
		(attr "Manufacturer_Part_Number" "DRV2605LDGST")
		(attr "Mouser Part Number" "595-DRV2605LDGST")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/DRV2605LDGST?qs=asCBFxFfL1TjvcNdZsR2BA%3D%3D")
		(attr "Arrow Part Number" "DRV2605LDGST")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/drv2605ldgst/texas-instruments?region=nac")
		(attr "Description" "ERM & LRA Device Haptic Driver 2-5V BGA9 Texas Instruments DRV2605LDGST Piezo Haptic Motor Driver IC, 5 V, 10-Pin VSSOP")
		(attr "Datasheet Link" "http://www.ti.com/lit/ds/symlink/drv2605l.pdf")
		(attr "Height" "1.1 mm")
	)
