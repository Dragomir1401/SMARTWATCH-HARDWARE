...
(library Library_1
	...
	(patternDef "SOT95P240X110-3N" (originalName "SOT95P240X110-3N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r85_60) (pt -1.25, 0.95) (rotation 90))
			(pad (padNum 2) (padStyleRef r85_60) (pt -1.25, -0.95) (rotation 90))
			(pad (padNum 3) (padStyleRef r85_60) (pt 1.25, 0) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -0.475 1.45) (pt 0.475 1.45) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0.475 1.45) (pt 0.475 -1.45) (width 0.2))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -1.675 1.5) (pt -0.825 1.5) (width 0.2))
		)
	)
	(symbolDef "BCR133" (originalName "BCR133")
	...
	(compDef "BCR133" (originalName "BCR133") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "BCR133"))
		...
		(attr "Manufacturer_Part_Number" "BCR133")
		(attr "Mouser Part Number" "")
		(attr "Mouser Price/Stock" "")
		(attr "Arrow Part Number" "")
		(attr "Arrow Price/Stock" "")
		(attr "Description" "Infineon, BCR133 NPN Digital Transistor, 100 mA 50 V 10 k, Ratio Of 1, 3-Pin SOT-23")
		(attr "<Hyperlink>" "https://www.infineon.com/dgdl/Infineon-BCR133SERIES-DS-v01_01-en.pdf?fileId=db3a30431428a37301143f7f8a3f0288")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "BCR133.stp")
